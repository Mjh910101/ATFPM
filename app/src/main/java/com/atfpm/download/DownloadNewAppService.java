	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		if (bundle != null) {
			updateNotification.setLatestEventInfo(context, getResources()
					...
					getResources().getString(R.string.prepare_download),
					updatePendingIntent);
			new Thread(new updateRunnable(bundle.getString(KEY))).start();
		} else {
			updateNotification.setLatestEventInfo(context, getResources()
					.getString(R.string.app_name),
					getResources().getString(R.string.failure_download),
					updatePendingIntent);
		...
		public void handleMessage(Message msg) {
			...
			case DOWNLOAD_FAIL:
				updateNotification.setLatestEventInfo(context, getResources()
						...
						.getString(R.string.failure_download),
						updatePendingIntent);
